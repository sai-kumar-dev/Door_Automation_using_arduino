...
// The door opens when motion is detected or when the Open button is pressed.
// Pressing Open again during opening increases the delay before closing.
// Motion detected during closing will retract the door (open again).
...
#define PIR_SENSOR 7  // PIR sensor pin
...
void loop() {
  ...
  // Open button logic or PIR sensor trigger
